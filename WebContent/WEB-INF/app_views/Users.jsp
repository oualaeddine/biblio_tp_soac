                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-sm">
                                        ...
                                        <tbody>
                                        <%
                                            LinkedList<EmployeesHomeStub.Employees> users = (LinkedList<EmployeesHomeStub.Employees>)request.getAttribute("users");
                                            for (EmployeesHomeStub.Employees user : users) {
                                        %>
                                        <tr>
                                            <td><%= user.getId()%>
                                            </td>
